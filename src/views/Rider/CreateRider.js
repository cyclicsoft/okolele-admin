...
export default function CreateRider() {
    ...
    // ######################### Create Rider Handler #########################
    const profileCreateHandler = (event) => {
        setCreationLog(true);

        axios.post("/multivendorshop/mv/v1/rider")
                            ...
                            {CreationLog ?
                                <GridContainer>
                                    <GridItem xs={12} sm={12} md={12} >
                                        <h4 className="create-admin-style">Rider ID: {ID}</h4>
                                        <h4 className="create-admin-style">Rider Password: {password}</h4>

...
export default function AdminManagement() {
  ...
  useEffect(() => {
    const pageNo = 0;
    const adminListByPagination =
      "/multivendorshop/mv/v1/admin/app/admin?page=" + pageNo + "&size=5";

    axios
      .get(adminListByPagination)
  ...
  const updateConfirmationFlag = (flag) => {
    if (password === confirmPassword && flag === true) {
      ...
      const adminUpdateByIdUrl =
        "/multivendorshop/mv/v1/admin/app/admin/" + adminId;
      axios.put(adminUpdateByIdUrl, userInfo).then(function (response) {
          ...
          <GridItem xs={12} sm={12} md={6}>
            <Card profile>
              ...
              <CardBody profile>
                ...
                {adminId ? (
                  <h5 className={classes.cardTitle}>ID: {adminId}</h5>
                ) : null}
          ...
          <GridItem xs={12} sm={12}>
            ...
            <Card>
              <CardHeader color="rose" icon>
                ...
                <h4 className={classes.cardIconTitle}>Edit Admin Profile</h4>
              </CardHeader>
              <CardBody>
                <GridContainer>
                  <GridItem xs={12} sm={12} md={6}>

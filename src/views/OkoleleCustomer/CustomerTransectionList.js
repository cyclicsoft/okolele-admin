...
export default function CustomerTransectionList() {
    ...
    const viewCustomerTransactions = (id) => {
        alert(id)
        setRiderId(id);
                        ...
                        <CardBody>
                            <Table
                                ...
                                tableData={riderList.map((user) => {
                                    console.log('Customer List: ', user);
                                        ...
                                        [
                                            ...
                                            <div>
                                                <Button style={{ margin: '2px' }}
                                                    ...
                                                    onClick={() => viewCustomerTransactions(riderId)}>
                        ...
                        <GridItem xs={12} sm={12} md={4} >
                            <Card profile style={{ marginLeft: '16px' }}>
                                ...
                                <CardBody profile>
                                    ...
                                    <p className={classes.cardTitle}>Customer ID: {riderId}</p>
                                    <p className={classes.cardTitle}>Customer Address: {address}</p>
